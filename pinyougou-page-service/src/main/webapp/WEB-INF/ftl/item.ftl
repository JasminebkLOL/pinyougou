		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					...
					<li class="active">iphone 6S系类{{specificationItems}}</li>
				</ul>
			</div>
			<!--product-info-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list spec.attributeValue as specOption>
									<dd>
										<a href="javascript:;" 
											class="{{isSelected('${spec.attributeName}','${specOption}')?'selected':''}}"
											ng-click="selectSpecification('${spec.attributeName}','${specOption}')">
											${specOption}<span title="点击取消选择">&nbsp;</span></a>
									</dd>
								</#list>
							</dl>
							</#list>
